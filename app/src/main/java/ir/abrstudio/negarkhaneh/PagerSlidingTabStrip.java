...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFFEEEEEE;
	private int underlineColor = 0xFFFFFFFF;
	private int dividerColor = 0xFFe5e5e5;
	...
	private Typeface tabTypeface =  Typeface.createFromAsset(getContext()
			.getAssets(), "BMITRA.TTF");
